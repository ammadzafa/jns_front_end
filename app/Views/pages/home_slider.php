...
<section class="section swiper-container swiper-slider swiper-slider-classic" data-loop="true" data-autoplay="4859" data-simulate-touch="true" data-direction="vertical" data-nav="false">
  <div class="swiper-wrapper text-center">
    <div class="swiper-slide" data-slide-bg="<?=base_url()?>assets/images/slider-1-slide-2-1770x742.jpg">
    ...
    <div class="swiper-slide" data-slide-bg="<?=base_url()?>assets/images/slider-1-slide-4-1770x742.jpg">
      <div class="swiper-slide-caption section-md">
        <div class="container">
    ...
    <div class="swiper-slide" data-slide-bg="<?=base_url()?>assets/images/slider-1-slide-6-1770x742.jpg">
      <div class="swiper-slide-caption section-md">
        <div class="container">
